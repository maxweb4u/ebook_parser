...
- [`New-Format Candidates Against The 0.1.0 Surfaces`](new-format-candidates.md) — Read when a new book format is proposed: what MOBI/AZW3, TXT, FB3, CBZ and PDF each cost against the surfaces frozen at 0.1.0, assessed 2026-09-01. Deferred by decision (2026-09-01): no new format lands before roughly five releases past 0.1.0.
- [`2026-09-01 Review: Recommendations That Are Not Defects`](deferred-recommendations.md) — Read before post-0.1.0 hardening or an API-evolution discussion: four improvements from the 2026-09-01 review that were deliberately not recorded as open questions.
